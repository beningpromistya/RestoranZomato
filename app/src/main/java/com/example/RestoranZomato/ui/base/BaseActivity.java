...
import com.example.RestoranZomato.di.component.ActivityComponent;
import com.example.RestoranZomato.di.component.DaggerActivityComponent;
import com.example.RestoranZomato.di.module.ActivityModule;
import com.example.RestoranZomato.service.LocationService;
import com.example.RestoranZomato.util.CommonUtils;
import com.example.RestoranZomato.util.KeyboardUtils;
import com.example.RestoranZomato.util.NetworkUtils;
...
public abstract class BaseActivity extends AppCompatActivity implements MvpView,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((RestoranZomato) getApplication()).getApplicationComponent())
                .build();
    }
